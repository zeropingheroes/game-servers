...
curl -L "http://zeropingheroes.ams3.digitaloceanspaces.com/GoldenEye_Source_v5.0.6_full_server_windows.7z" > "$DIR/server/GoldenEye_Source_v5.0.6_full_server_windows.7z"
